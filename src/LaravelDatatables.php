...
use SantosSabanari\LaravelDatatables\Traits\Checkboxes;
use SantosSabanari\LaravelDatatables\Traits\Loading;
use SantosSabanari\LaravelDatatables\Traits\Offline;
use SantosSabanari\LaravelDatatables\Traits\Pagination;
use SantosSabanari\LaravelDatatables\Traits\Search;
use SantosSabanari\LaravelDatatables\Traits\Sorting;
use SantosSabanari\LaravelDatatables\Traits\Table;
use SantosSabanari\LaravelDatatables\Traits\Yajra;

abstract class LaravelDatatables extends Component
{
    use Checkboxes,
        Loading,
        Offline,
    ...
    /**
     * Use constructor instead of mount so that the child classes have access to a mount method that they can accept
     * parameters in.
     *
    ...
    {
        return 'laravel-datatables::laravel-datatables';
    }
